<template>
  <ModalBase :open="open" @clickAway="$emit('close')">
    <div class="relative container window-sub h-full lg:h-auto overflow-hidden" @click.stop="">
      <div class="relative h-full overflow-x-hidden overflow-y-auto">
        <h2 class="text-lg font-bold mb-4">直接使用しているライブラリのライセンス</h2>
        ...
        <h2 class="text-lg font-bold mb-4">利用素材(アイコン、画像等)</h2>
